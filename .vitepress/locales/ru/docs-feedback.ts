...
const docReaction: CustomConfig['docReaction'] = {
  feedbackMsg: 'Эта инормация была полезна?',
  good: 'Да',
  bad: 'Нет',
  ...
  badFeedbackSuccessMsg: 'Пожалуйста дайте нам узнать подробности',
  form: {
    ...
    contentImgLinkIssue: 'Ошибка формулировок, неверные изображение или нерабочие ссылки',
    feedbackDetail: 'Обратная связь / предложение по улучшению',
    feedbackTip: 'Пожалукйста подробно опишите проблему или предложение по улучшению.',
